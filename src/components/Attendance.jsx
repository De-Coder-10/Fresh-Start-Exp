...
//     selectedSem && attendanceData[selectedSem.registration_id];
//   const subjects =
//     selectedAttendance?.studentattendancelist?.map((item) => {
//       const attended =
//         (item.Ltotalpres || 0) + (item.Ttotalpres || 0) + (item.Ptotalpres || 0);
//       const total =
//         (item.Ltotalclass || 0) +
//         (item.Ttotalclass || 0) +
//         (item.Ptotalclass || 0);
//       const combined = (attended / total) * 100;
...
//         combined,
//         lecture: item.Lpercentage,
//         tutorial: item.Tpercentage,
//         practical: item.Ppercentage,
...
//   <div className="text-white font-sans bg-[#0e0f11] min-h-screen">
//     {/* Sticky Header */}
//     <div className="sticky top-14 z-30 bg-[#16191d] border-b border-gray-700 shadow-md">
//       <div className="flex flex-wrap items-center justify-between gap-4 px-6 py-5">
//         {/* Semester Selector */}
//         <Select onValueChange={handleSemesterChange} value={selectedSem?.registration_id}>
//           <SelectTrigger className="bg-[#1e2126] text-white border border-gray-600 rounded-lg px-4 py-2 shadow hover:border-gray-400 transition-colors duration-200">
//             <SelectValue>
//               {isAttendanceMetaLoading ? "Loading..." : selectedSem?.registration_code || "Select Semester"}
//             </SelectValue>
//           </SelectTrigger>
//           <SelectContent className="bg-[#1e2126] text-white border border-gray-600 rounded-lg shadow-lg">
...
//           min="0"
//           max="100"
//           className="w-32 bg-[#384860] text-white border border-gray-600 rounded-lg px-4 py-2 shadow focus:ring-2 focus:ring-blue-500 transition duration-200"
//           placeholder="Goal %"
//         />
//       </div>
//     </div>
...
//   <div className="flex items-center justify-center py-10 text-gray-400 text-lg font-medium">
//     Loading attendance...
//   </div>
// ) : (
//   <Tabs value={activeTab} onValueChange={setActiveTab} className="px-4 sm:px-6 pb-10">
    
//     {/* Tabs Navigation */}
//     <TabsList className="flex bg-[#1f232a] border border-gray-700 rounded-2xl shadow-md overflow-hidden w-full mb-6">
//       <TabsTrigger
//         value="overview"
//         className="w-full text-white text-sm sm:text-base font-medium px-4 sm:px-6 py-3 transition-all duration-150 ease-in-out hover:bg-[#2a2e33] data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-purple-600 data-[state=active]:text-white"
//       >
//         Overview
//       </TabsTrigger>
...
//       {selectedAttendance?.error ? (
//         <div className="py-6 text-center text-red-400 font-semibold text-sm">
//           {selectedAttendance.error}
//         </div>
//       ) : (
...
//       <div className="text-gray-300 text-sm font-medium text-center py-10">
//         Day-to-Day attendance details coming soon ✨
//       </div>
//     </TabsContent>
//   </Tabs>
// )}
